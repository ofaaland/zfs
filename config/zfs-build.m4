...
AC_DEFUN([ZFS_AC_RPM], [
	...
	RPM_DEFINE_KMOD='--define "kernels $(LINUX_VERSION)" --define "require_spldir @abs_top_srcdir@" --define "require_splobj @abs_top_srcdir@" --define "ksrc $(LINUX)" --define "kobj $(LINUX_OBJ)"'
	RPM_DEFINE_DKMS=
